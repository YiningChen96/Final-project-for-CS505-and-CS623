...
public class Patient {
	...
	protected static JMenuItem item4;
	...
	public Patient() {
		...
		try {
			...
			//use setmetadata method to get all the values in resultset and output them by using while loop and for each;
	...
	//these method to make gui interfaces;
	...
	//add more functions via menubar;
	public void makeMenu() {
		...
		item2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					sql="select * from hospital.patient order by department;";
		...
		item3=new JMenuItem("Order by Doctor");
		item3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					sql="select * from hospital.patient order by RESPONSIBLE_DOCTOR_NUMBER;";
		...
		item4=new JMenuItem("Order by Diagnosis");
		item4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					sql="select * from hospital.patient order by diagnosis;";
	...
	public void makeTextArea() {
		...
		outcome.setBounds(20,20,1080,580);    
	    iPanel.add(outcome);
	}
	
	public void makeScrollBar() {
	ScrollBar = new JScrollPane(outcome);
	ScrollBar.setBounds(20, 20, 1080, 580);
