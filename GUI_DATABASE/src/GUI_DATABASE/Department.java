...
public class Department {
	//these variables for gui design;
	...
	//these variable for jdbc driver;
	...
	public Department() {
		...
		try {
			...
			//to turn all outcome in a resultset to a resultsetmetada to output them
			ResultSetMetaData dataset =resultSet.getMetaData();
			int columnsNumber = dataset.getColumnCount();
			//use while loop and for each statement to output both both columnname and value to the textArea
	...
	//these methods to make a gui interface;
